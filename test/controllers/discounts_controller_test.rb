...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { code: @discount.code, description: @discount.description, quantity: @discount.quantity, title: @discount.title, discount_type: @discount.discount_type, user_id: @discount.user_id }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { code: @discount.code, description: @discount.description, quantity: @discount.quantity, title: @discount.title, discount_type: @discount.discount_type, user_id: @discount.user_id }
    assert_redirected_to discount_path(assigns(:discount))
  end
